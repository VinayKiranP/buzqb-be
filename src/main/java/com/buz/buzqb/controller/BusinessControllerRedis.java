...
public class BusinessControllerRedis {

  @Autowired
  private BusinessService businessService;

  public static final Logger LOGGER = LoggerFactory.getLogger(BusinessControllerRedis.class.getName());
  ...
  @GetMapping("/{id}")
  @Cacheable(key = "#id", value = Constants.REDIS_HASH_KEY_BUSINESS)
